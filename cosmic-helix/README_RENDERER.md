...
2. A 1440×900 canvas renders four static layers:
   - **Vesica field** — intersecting circles shaping the Vesica Piscis of classical geometry.
   - **Tree-of-Life scaffold** — ten sephirot with twenty-two paths drawn from Kabbalistic diagrams.
   - **Fibonacci curve** — golden spiral polyline inspired by Leonardo of Pisa's *Liber Abaci* (1202).
   - **Double-helix lattice** — two phase-shifted sine tracks echoing Watson and Crick's 1953 DNA model.
