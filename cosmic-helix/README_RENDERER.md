...
## Extending
Add new draw functions in `js/helix-renderer.mjs` while preserving the calm visual hierarchy and ND-safe choices. Document any additions with inline comments explaining **why** the geometry or colour choices honour the canon.
