...
3. Palette colours live in `data/palette.json`. If the file is missing, a safe default loads and a notice appears.
...
## Extending
Add more layers by expanding `renderHelix` while keeping the calm visual hierarchy.
