...
2. A 1440×900 canvas renders four static layers:
   ...
   - **L1 Vesica field** — intersecting circles forming the womb of forms.
   - **L2 Tree-of-Life scaffold** — ten sephirot with twenty-two paths.
   - **L3 Fibonacci curve** — golden spiral polyline anchored to centre.
   - **L4 Double-helix lattice** — two phase-shifted sine tracks.
...
- Geometry parameters honour numerology constants 3, 7, 9, 11, 22, 33, 99, 144.
...
## Extending
The renderer is intentionally minimal. Future layers or overlays can extend `renderHelix` with new draw functions while preserving the calm visual hierarchy.
