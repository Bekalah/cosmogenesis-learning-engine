...
3. Palette colours live in `data/palette.json`. If the file is missing, a safe default palette loads and a notice appears.
...
## Design notes
- Pure ES module (`js/helix-renderer.mjs`) with small, well-commented functions and ASCII quotes.
